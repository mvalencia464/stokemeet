  ...
  return (
    <div className="flex gap-6 border-b border-[#30363d] px-4 mt-6">
      <button
        ...
        className={`pb-3 text-sm font-semibold transition-colors relative ${activeTab === 'summary' ? 'text-[#0070f3]' : 'text-[#8b949e] hover:text-[#e6edf3]'
          }`}
      >
        SUMMARY
      ...
      <button
        ...
        className={`pb-3 text-sm font-semibold transition-colors relative ${activeTab === 'transcript' ? 'text-[#0070f3]' : 'text-[#8b949e] hover:text-[#e6edf3]'
          }`}
      >
        TRANSCRIPT
      ...
      <button
        ...
        className={`pb-3 text-sm font-semibold transition-colors relative ${activeTab === 'ask' ? 'text-[#0070f3]' : 'text-[#8b949e] hover:text-[#e6edf3]'
          }`}
      >
        ASK STOKEMEET
